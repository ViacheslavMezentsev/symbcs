...
public class Vector : Algebraic, IEnumerable
{
    ...
    public Vector( int n ) : this( Symbolic.ZERO, n )
    {
    }
    ...
    public static Algebraic operator +( Vector lhs, Algebraic rhs )
    {
        ...
        throw new JasymcaException( "Wrong type of operand." );
    }
    ...
    public static Algebraic operator +( Vector lhs, Vector rhs )
    {
        ...
        throw new JasymcaException( "Wrong vector dimension." );
    }
    ...
    public static Algebraic operator *( Vector lhs, Vector rhs )
    {
        if ( rhs.Length() == lhs._items.Length )
        {
            ...
            return r.Aggregate( Symbolic.ZERO, ( s, x ) => ( Symbolic ) ( s + x ) );
        }
    ...
    public static Algebraic operator /( Vector lhs, Algebraic rhs )
    {
        ...
        throw new JasymcaException( "Divide not implemented for vectors" );
    }
