...
namespace Tiny.Octave
{
    public class OctaveParser : Parser
    {
        ...
        public OctaveParser( Store env ) : base( env )
        {
            env.addPath( "." );
            env.addPath( "m" );
        ...
        public override void translate( string expr )
        {
            if ( expr == null )
            {
                return;
        ...
        public override bool commandq( object expr )
        {
