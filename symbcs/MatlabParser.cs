...
internal class MatlabParser : Parser
{
	...
	public MatlabParser(Environment env) : base(env)
	{
		...
		env.globals.put("sum", "$sum2");
		pst = new ParserState(null, 0);
		Operator.OPS = new Operator[]{new Operator("PPR", "++", 1, RIGHT_LEFT, Constants_Fields.UNARY | LVALUE), new Operator("MMR", "--", 1, RIGHT_LEFT, Constants_Fields.UNARY | LVALUE), new Operator("PPL", "++", 1, Constants_Fields.LEFT_RIGHT, Constants_Fields.UNARY | LVALUE), new Operator("MML", "--", 1, Constants_Fields.LEFT_RIGHT, Constants_Fields.UNARY | LVALUE), new Operator("ADE", "+=",10, RIGHT_LEFT, BINARY | LVALUE), new Operator("SUE", "-=",10, RIGHT_LEFT, BINARY | LVALUE), new Operator("MUE", "*=",10, RIGHT_LEFT, BINARY | LVALUE), new Operator("DIE", "/=",10, RIGHT_LEFT, BINARY | LVALUE), new Operator("MUL", ".*", 3, Constants_Fields.LEFT_RIGHT, BINARY), new Operator("DIV", "./", 3, Constants_Fields.LEFT_RIGHT, BINARY), new Operator("POW", ".^", 1, Constants_Fields.LEFT_RIGHT, BINARY), new Operator("EQU", "==", 6, Constants_Fields.LEFT_RIGHT, BINARY), new Operator("NEQ", "~=", 6, Constants_Fields.LEFT_RIGHT, BINARY), new Operator("GEQ", ">=", 6, Constants_Fields.LEFT_RIGHT, BINARY), new Operator("LEQ", "<=", 6, Constants_Fields.LEFT_RIGHT, BINARY), new Operator("GRE", ">", 6, Constants_Fields.LEFT_RIGHT, BINARY), new Operator("LES", "<", 6, Constants_Fields.LEFT_RIGHT, BINARY), new Operator("OR", "|", 9, Constants_Fields.LEFT_RIGHT, BINARY), new Operator("NOT", "!", 8, Constants_Fields.LEFT_RIGHT, Constants_Fields.UNARY), new Operator("AND", "&", 7, Constants_Fields.LEFT_RIGHT, BINARY), new Operator("GRE", ">", 6, Constants_Fields.LEFT_RIGHT, BINARY), new Operator("GRE", ">", 6, Constants_Fields.LEFT_RIGHT, BINARY), new Operator("ASS", "=", 10, RIGHT_LEFT, BINARY | LVALUE), new Operator("CR1", ":", 5, Constants_Fields.LEFT_RIGHT, BINARY | TERNARY), new Operator("ADD", "+", 4, Constants_Fields.LEFT_RIGHT, Constants_Fields.UNARY | BINARY), new Operator("SUB", "-", 4, Constants_Fields.LEFT_RIGHT, Constants_Fields.UNARY | BINARY), new Operator("MMU", "*", 3, Constants_Fields.LEFT_RIGHT, BINARY), new Operator("MDR", "/", 3, Constants_Fields.LEFT_RIGHT, BINARY), new Operator("MDL", "\\", 3, Constants_Fields.LEFT_RIGHT, BINARY), new Operator("MPW", "^", 1, Constants_Fields.LEFT_RIGHT, BINARY), new Operator("ADJ", "'", 1, RIGHT_LEFT, Constants_Fields.UNARY)};
