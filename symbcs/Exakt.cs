...
public class Exakt : Zahl
{
	...
	private double[] cfs(double x, double tol)
	{
		...
		double error ; double[] y = new double[2];
		tol = Math.Abs(x * tol);
...
//ORIGINAL LINE: Exakt cfs(double tol1) throws JasymcaException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: private BigInteger[] cfs(java.util.Vector a) throws JasymcaException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: private BigInteger[] div(BigInteger[] x, BigInteger[] y) throws JasymcaException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public boolean smaller(Zahl x) throws JasymcaException
...
//JAVA TO C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: public Exakt gcd(Exakt x) throws JasymcaException
