...
namespace Tiny.Symbolic
{
    ...
    internal class LambdaROMBERG : Lambda
    {
        public override int Eval( Stack st )
        {
            ...
            var a1 = Globals.Proc.Store.getnum( "rombergit" );
            ...
            a1 = Globals.Proc.Store.getnum( "rombergtol" );
        ...
        internal virtual Algebraic trapez( Algebraic exp, Variable v, int n, double a, double b )
        {
            ...
            sum = exp.Value( v, new Complex( a ) ) + sum * Symbol.TWO + exp.Value( v, new Complex( b ) );
